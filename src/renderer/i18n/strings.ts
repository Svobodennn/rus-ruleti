    ...
    destruction: {
      ...
      win: {
        ...
        explorer: {
          ...
          dataDisk: 'Данные',
          ctxOpen: 'Открыть',
          ctxOpenNewWindow: 'Открыть в новом окне',
          ctxPin: 'Закрепить на панели быстрого доступа',
          ctxRename: 'Переименовать',
          ctxDelete: 'Удалить',
          devicesAndDrives: 'Устройства и диски',
          searchPlaceholder: 'Поиск на этом компьютере',
          colName: 'Имя',
          ...
          accessDenied: {
            title: 'Нет доступа к папке',
            headline:
              'Для удаления этой папки требуется разрешение администратора',
            body: 'Вам отказано в доступе к этой папке. Для удаления System32 требуются права администратора.',
            continue: 'Продолжить',
            cancel: 'Отмена',
          },
        },
    ...
    destruction: {
      ...
      win: {
        ...
        explorer: {
          ...
          dataDisk: 'Veri',
          ctxOpen: 'Aç',
          ctxOpenNewWindow: 'Yeni pencerede aç',
          ctxPin: "Başlat'a sabitle",
          ctxRename: 'Yeniden adlandır',
          ctxDelete: 'Sil',
          devicesAndDrives: 'Aygıtlar ve sürücüler',
          searchPlaceholder: 'Bu bilgisayarda ara',
          colName: 'Ad',
          colDate: 'Değiştirilme tarihi',
          colType: 'Tür',
          colSize: 'Boyut',
          fileFolder: 'Dosya klasörü',
          accessDenied: {
            title: 'Klasör Erişimi Reddedildi',
            headline:
              'Bu klasörü silmek için yönetici izni sağlamanız gerekir',
            body: 'Bu klasöre erişiminiz reddedildi. System32 klasörünü silmek için yönetici izni gerekir.',
            continue: 'Devam et',
            cancel: 'İptal',
          },
        },
